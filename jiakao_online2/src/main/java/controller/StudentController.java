...
public class StudentController {
	...
	public @ResponseBody String managerAddStudent(Student student)throws Exception{
	...
	public @ResponseBody String managerUpdateStudent(Student student)throws Exception{
